  ...
  const handleSubmit = async (event: FormEvent) => {
    ...
    try {
      ...
      const message = isQuotaError
        ? "Gemini quota is exhausted for this API key. Check billing, quota, or try again later."
      ...
      setMessages([
        ...nextMessages,
        {
          role: "bot",
          text: isQuotaError
            ? "Gemini is currently refusing requests because this key has no available quota. AI Solution currently lists 4 services: Web Development, Mobile App Development, Cloud Solutions, and AI & Machine Learning."
