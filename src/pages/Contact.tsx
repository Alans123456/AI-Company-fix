...
export function Contact() {
  ...
  const { register, handleSubmit, formState: { errors }, trigger, getValues, setValue, watch } = useForm<ContactFormData>()
  ...
  const onSubmit = async (data: ContactFormData) => {
    ...
    try {
      ...
      const response = await submitContactForm(data) as { success: boolean; message: string; confirmationNumber: string }
                  ...
                  {currentStep === 2 && (
                    <div className="space-y-4">
                      <div>
                        ...
                        <Textarea
                          id="jobDetails"
                          {...register("jobDetails", { required: "Project details are required" })}
                          placeholder="Please describe your project requirements, goals, and any specific features you need..."
                          className="mt-1 min-h-[120px]"
                        />
                        {errors.jobDetails && (
                          <p className="text-red-500 text-sm mt-1">{errors.jobDetails.message}</p>
                        )}
                      </div>
                      <div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-300">hello@techsolutions.com</p>
                  </div>
                </div>
            ...
            <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-xl">
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-300">
                    Absolutely! We specialize in integrating with existing systems and can work with any technology stack.
                  </p>
                </div>
              </CardContent>
            </Card>
